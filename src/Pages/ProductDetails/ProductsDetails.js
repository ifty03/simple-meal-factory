...
const ProductsDetails = () => {
  ...
  return (
    <div>
      <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-coolGray-900 dark:text-coolGray-100 mx-auto my-8">
        ...
        <div>
          <img
            ...
            alt=""
            className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-coolGray-500"
          />
          <h2 className="mb-1 text-xl font-semibold">{product?.strMeal}</h2>
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="flex space-x-2 text-sm dark:text-coolGray-400">
